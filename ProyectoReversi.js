...
socket.on('ready', function(data){
  ...
  console.log("tiroooooooooooooooooooooooooooooo");
...
function MaxValue(vueltas,ActualBoard1,depth,alpha,beta){
    ...
    //validacion para dejar de dar vueltas si ya no hay tiros posibles 
...
function MinValue(vueltas,ActualBoard1,depth,alpha,beta){
  ...
  function value(vueltas,type,ActualBoard1,depth,alpha,beta){
    ...
    //tomaos como hojas solo cuando el turno anterior fue un max 
...
//*************************************************************************************
  ...
  //heuristica de matriz de pesos , cada tiro tiene un valor 
  ...
  // Heuristica para los tableros que ya no tienen mas tiros posibles #gg
  ...
  function flipHeuritic(ActualBoard,turnID){
    ...
    for (var i = 0; i <=7; i++) {
      for (var j= 0; j <=7; j++){
        ...
        console.log("regreso alguna baina "+peso);
